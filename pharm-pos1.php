...
<body>
    ...
    <div class="center-content">
        <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
            <select id="cid" name="cid" style="width: 300px; padding: 8px;">
        ...
        if(isset($_POST['custadd'])) {
            ...
            if(!($result2 = $conn->query($qry2))) {
                echo "<p class='error-message'>Invalid! Enter valid Customer ID to record Sales.</p>";    
            }
        }
        ?>
        
        <form method="post">
            <select id="med" name="med" style="width: 300px; padding: 8px;">
        ...
        <div class="one row">
            <form method="post">
                ...
                <input type="number" name="mcqty" style="width: 100px;">
                &nbsp;&nbsp;&nbsp;
                ...
                if(isset($_POST['add'])) {
                    ...
                    if($qty > $aqty || $qty == 0) {
                        echo "<p class='error-message'>QUANTITY INVALID!</p>";
                    } else {
